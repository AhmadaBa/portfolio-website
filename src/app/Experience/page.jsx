          ...
          <div className="space-y-12">
            <div className="pb-8 opacity-0 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
              ...
              <ul className="mt-4 list-arrow space-y-4">
                <li className="opacity-0 animate-fadeIn" style={{ animationDelay: '0.2s' }}> Refactored legacy code to utilize async/await, resulting in a 40% improvement in system performance and responsiveness.</li>
                <li className="opacity-0 animate-fadeIn" style={{ animationDelay: '0.3s' }}> Engineered sophisticated REST API controller modules for seamless HTTP request handling, CRUD operations, and integration with MongoDB and Salesforce (Apache Cassandra) databases.</li>
                <li className="opacity-0 animate-fadeIn" style={{ animationDelay: '0.4s' }}> Played a pivotal role in migrating service APIs from Node.js 18 to Node.js 20, leading to enhanced website loading speeds, increased service reliability, and optimized server memory utilization.</li>
                <li className="opacity-0 animate-fadeIn" style={{ animationDelay: '0.5s' }}> Authored and implemented comprehensive unit and integration tests, achieving a 30% increase in test coverage across six microservices, thereby significantly enhancing system reliability and maintainability.</li>
